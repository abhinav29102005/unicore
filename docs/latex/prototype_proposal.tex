...
\begin{abstract}
The UniCore Prototype is a database-first software application engineered to demonstrate real-time transaction safeguards, PL/SQL trigger automation, role-based authentication, and immutable audit logging.
\end{abstract}
